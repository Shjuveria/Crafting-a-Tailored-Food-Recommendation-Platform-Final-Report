...
#conn = pyodbc.connect('Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=C:\Users\irfan\Desktop\CravingsHut All-files\final\Database.accdb;')
conn = pyodbc.connect('Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ = C:/Users/sjuveria1/Downloads/CravingsHut All-files;')
cursor = conn.cursor()
